...
unsafe extern "C" {
    pub safe fn SDL_CreateRenderer(window: SDLWindow, index: i32, flags: u32) -> SDLRenderer;
    pub safe fn SDL_CreateTexture(
    ...
    pub safe fn SDL_DestroyRenderer(renderer: SDLRenderer);
    pub safe fn SDL_DestroyTexture(texture: SDLTexture);
    pub safe fn SDL_DestroyWindow(window: SDLWindow);
    pub safe fn SDL_GetError() -> &'static CStr;
    pub safe fn SDL_GetPixelFormatName(format: SDLPixelFormat) -> &'static CStr;
    pub safe fn SDL_GetRelativeMouseState(x: &mut i32, y: &mut i32) -> i32;
    pub safe fn SDL_GetWindowPixelFormat(window: SDLWindow) -> SDLPixelFormat;
    pub safe fn SDL_PollEvent(event: &mut SDLEvent) -> bool;
    pub safe fn SDL_RenderClear(renderer: SDLRenderer) -> i32;
    pub safe fn SDL_RenderCopy(
        renderer: SDLRenderer,
        texture: SDLTexture,
        srcrect: Option<&SDLRect>,
        dstrect: Option<&SDLRect>,
    ) -> i32;
    pub safe fn SDL_RenderPresent(renderer: SDLRenderer);
    pub safe fn SDL_UpdateTexture(
        texture: SDLTexture,
        rect: Option<&SDLRect>,
        pixels: *const u32,
        pitch: i32,
